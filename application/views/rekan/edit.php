<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Form Edit Vendor Pegawai</h1>
    </section>
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="id_rekan" value="<?= $rekan['id_rekan']; ?>" readonly>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nm_rekan" value="<?= $rekan['nm_rekan']; ?>">
                                </div>
